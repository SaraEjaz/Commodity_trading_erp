...
from .serializers import CommissionDealSerializer
...
class CommissionDealViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        serializer = CommissionDealSerializer(data=request.data)
    ...
    def update(self, request, *args, **kwargs):
        deal = self.get_object()
        serializer = CommissionDealSerializer(deal, data=request.data, partial=True)
        serializer.is_valid(raise_exception=True)
        serializer.save()
        return Response(serializer.data)
